...
\section*{Other stuffs to do}

% Agents: Don't touch anything in this section.
\begin{enumerate}
  \item 1-loop Kahler potential in terms of CY spectrum data, string loops to non-compact CY cones. [BHK '04, 0508043, BHP '06][1308.2157]: Extract from 0-pt amplitudes with specific spin structure?
  \item Warping corrections in KS from worldsheet (singular conifold + ND3/MD5), starting from conifold + RR flux/warping deformation, find SFT solution? -- Need full spectrum of the singular conifold CFT, take limit where CFT reduces to $\mathcal{N}=2$ Liouville?
\end{enumerate}
